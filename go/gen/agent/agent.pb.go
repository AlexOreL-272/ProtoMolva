...
type GetCurrencyAccountsResponse struct {
	...
	CurrencyAccounts *CurrencyAccount `protobuf:"bytes,1,opt,name=currency_accounts,json=currencyAccounts,proto3" json:"currency_accounts,omitempty"`
}
