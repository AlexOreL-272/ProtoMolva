...
const (
	...
	Crm_CreateOneTimePassword_FullMethodName     = "/handlers.api.Crm/CreateOneTimePassword"
	Crm_CheckOneTimePassword_FullMethodName      = "/handlers.api.Crm/CheckOneTimePassword"
	Crm_CheckPasswordResetToken_FullMethodName   = "/handlers.api.Crm/CheckPasswordResetToken"
)
...
type CrmClient interface {
	...
	// сброс пароля
	CreateOneTimePassword(ctx context.Context, in *CreateOneTimePasswordRequest, opts ...grpc.CallOption) (*CreateOneTimePasswordResponse, error)
	CheckOneTimePassword(ctx context.Context, in *CheckOneTimePasswordRequest, opts ...grpc.CallOption) (*CheckOneTimePasswordResponse, error)
...
func (c *crmClient) CreateOneTimePassword(ctx context.Context, in *CreateOneTimePasswordRequest, opts ...grpc.CallOption) (*CreateOneTimePasswordResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOneTimePasswordResponse)
	err := c.cc.Invoke(ctx, Crm_CreateOneTimePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crmClient) CheckOneTimePassword(ctx context.Context, in *CheckOneTimePasswordRequest, opts ...grpc.CallOption) (*CheckOneTimePasswordResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckOneTimePasswordResponse)
	err := c.cc.Invoke(ctx, Crm_CheckOneTimePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crmClient) CheckPasswordResetToken(ctx context.Context, in *CheckPasswordResetTokenRequest, opts ...grpc.CallOption) (*CheckPasswordResetTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckPasswordResetTokenResponse)
	err := c.cc.Invoke(ctx, Crm_CheckPasswordResetToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CrmServer interface {
	...
	// сброс пароля
	CreateOneTimePassword(context.Context, *CreateOneTimePasswordRequest) (*CreateOneTimePasswordResponse, error)
	CheckOneTimePassword(context.Context, *CheckOneTimePasswordRequest) (*CheckOneTimePasswordResponse, error)
...
func (UnimplementedCrmServer) CreateOneTimePassword(context.Context, *CreateOneTimePasswordRequest) (*CreateOneTimePasswordResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOneTimePassword not implemented")
}
func (UnimplementedCrmServer) CheckOneTimePassword(context.Context, *CheckOneTimePasswordRequest) (*CheckOneTimePasswordResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckOneTimePassword not implemented")
}
func (UnimplementedCrmServer) CheckPasswordResetToken(context.Context, *CheckPasswordResetTokenRequest) (*CheckPasswordResetTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckPasswordResetToken not implemented")
}
...
func _Crm_CreateOneTimePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOneTimePasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrmServer).CreateOneTimePassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Crm_CreateOneTimePassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrmServer).CreateOneTimePassword(ctx, req.(*CreateOneTimePasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Crm_CheckOneTimePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckOneTimePasswordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrmServer).CheckOneTimePassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Crm_CheckOneTimePassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrmServer).CheckOneTimePassword(ctx, req.(*CheckOneTimePasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Crm_CheckPasswordResetToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckPasswordResetTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CrmServer).CheckPasswordResetToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Crm_CheckPasswordResetToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrmServer).CheckPasswordResetToken(ctx, req.(*CheckPasswordResetTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Crm_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateOneTimePassword",
			Handler:    _Crm_CreateOneTimePassword_Handler,
		},
		{
			MethodName: "CheckOneTimePassword",
			Handler:    _Crm_CheckOneTimePassword_Handler,
		},
		{
			MethodName: "CheckPasswordResetToken",
			Handler:    _Crm_CheckPasswordResetToken_Handler,
		},
	},
